...
# for converting python data type into byte stream(binary)
import pickle
...
message = tk.Label(window, text="Face Attendance Registry", bg="#557387", fg="white", width=30, height=2,
...
message = tk.Label(window, text="", bg="#ade0c9", fg="black", width=30, height=1, activebackground="yellow",
                   font=('times', 15, ' bold '))
message.place(x=350, y=240)

lbl3 = tk.Label(window, text="Attendance : ", width=15, fg="black", bg="#ade0c9", height=2,
                font=('times', 15, ' bold  underline'))
lbl3.place(x=400, y=650)

message2 = tk.Label(window, text="", fg="black", bg="#ade0c9", activeforeground="green", width=30, height=2,
                    font=('times', 15, ' bold '))
...
clearButton = tk.Button(window, text="x", command=clear, fg="black", bg="#ade0c9", width=4, height=1,
                        activebackground="Red", font=('times', 10, ' bold '))
clearButton.place(x=510, y=120)
clearButton2 = tk.Button(window, text="x", command=clear2, fg="black", bg="#ade0c9", width=4, height=1,
                         activebackground="Red", font=('times', 10, ' bold '))
clearButton2.place(x=510, y=180)
takeImg = tk.Button(window, text="Take Images", command=user_input, fg="black", bg="#ade0c9", width=15, height=1,
                    activebackground="Red", font=('times', 10, ' bold '))
takeImg.place(x=120, y=300)
trainImg = tk.Button(window, text="Train Images", command=training_lbph, fg="black", bg="#ade0c9", width=15, height=1,
                     activebackground="Red", font=('times', 10, ' bold '))
trainImg.place(x=250, y=300)
trackImg = tk.Button(window, text="Recognize", command=our_recognition, fg="black", bg="#ade0c9", width=15, height=1,
                     activebackground="Red", font=('times', 10, ' bold '))
...
AttendImg = tk.Button(window, text="Show Attendance", command=att, fg="black", bg="#ade0c9", width=15, height=1,
                      activebackground="Red", font=('times', 10, ' bold '))
AttendImg.place(x=510, y=300)
quitWindow = tk.Button(window, text="Quit", command=window.destroy, fg="black", bg="#ade0c9", width=15, height=1,
                       activebackground="Red", font=('times', 10, ' bold '))
quitWindow.place(x=640, y=300)
